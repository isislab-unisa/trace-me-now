...
The server engine is realized using AWS Lambda functions actions in response to events and manage interaction with the other components.
...
Finally, the system security is based on AWS Identity and Access Management.
